      ...
      <main className="center">
        <div className="containerPayment">
          <div className="paymentLeft">
            <RowPayment
              type={"address"}
              changeModal={setShowModalAddress}
              changeAddress={setLastAddress}
              lastAddress={lastAddress}
              addressEmpty={addressEmpty}
              changeAddressEmpty={setAddressEmpty}
              modal={modalOpenAddress}
              changeModalLast={setModalOpenAddress}
            />
            <div className="linePayment"></div>
            <RowPayment
              type={"billing"}
              changeModal={setShowModalBilling}
              billingEmpty={billingEmpty}
              changeBillingEmpty={setBillingEmpty}
              modal={modalOpenBilling}
              changeModalLast={setModalOpenBilling}
              changeBilling={setLastBilling}
        ...
        {showModalAddress && (
          <ModalInfo
            change={setShowModalAddress}
            type="paymentAddress"
            changeLastAddress={setLastAddress}
            changeAddressEmpty={setAddressEmpty}
            closeModalLast={setModalOpenAddress}
          />
        )}
        {showModalBilling && (
          <ModalInfo
            change={setShowModalBilling}
            type="paymentBilling"
            changeLastBilling={setLastBilling}
            changeBillingEmpty={setBillingEmpty}
            closeModalLast={setModalOpenBilling}
          />
        )}
      </main>
      <BtnUp />
