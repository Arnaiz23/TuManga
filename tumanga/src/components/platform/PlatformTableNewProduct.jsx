    ...
    <section>
      {loading ? (
        ...
        <>
          ...
          <div className="inputAdmin">
            <label htmlFor="price">
              Precio <span className="obligatoryFields">*</span>
            </label>
            <input
              type="number"
              id="price"
          ...
          <div className="inputAdmin">
            <label htmlFor="description">
              Descripción <span className="obligatoryFields">*</span>
            </label>
            <textarea
              name="description"
              id="description"
          ...
          <div className="inputAdmin">
            <label htmlFor="short_description">
              Descripción Corta <span className="obligatoryFields">*</span>
            </label>
            <textarea
          ...
          <div className="inputAdmin">
            <label htmlFor="stock">
              Stock <span className="obligatoryFields">*</span>
            </label>
            <input
              type="number"
              id="stock"
          ...
          <div className="inputAdmin">
            <label htmlFor="categories">
              Categorias <span className="obligatoryFields">*</span>
            </label>
            <form
          ...
          <div className="inputAdmin">
            <label htmlFor="type">
              Tipo <span className="obligatoryFields">*</span>
            </label>
            <select
              id="type"
              name="type"
          ...
          <div className="inputAdmin">
            <label>
              Imagen <span className="obligatoryFields">*</span>
            </label>
