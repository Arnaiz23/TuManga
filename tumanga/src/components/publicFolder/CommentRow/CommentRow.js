            ...
            <div className="row">
                ...
                <main>
                    <div className="rowStars">
                        {
                            stars.map(star => {
                                return <i key={star + comment._id}><FontAwesomeIcon icon={faStar} className={(comment.score >= star) ? "starsActive" : ""} /></i>
                            })
                        }
                    </div>
                    <p>{comment.message}</p>
                ...
                {currentlUser === userId &&
                    <footer>
                        <i onClick={deleteComment}><FontAwesomeIcon icon={faTrash} /></i>
                    </footer>
                }
            </div>
            <div className="lineComments"></div>
